...
import (
	...
	exampleclientset "website-controller/pkg/client/clientset/versioned"
	examplescheme "website-controller/pkg/client/clientset/versioned/scheme"
	exampleinformers "website-controller/pkg/client/informers/externalversions/smartx.com/v1"
	examplelisters "website-controller/pkg/client/listers/smartx.com/v1"
)

const controllerAgentName = "website-controller"
...
type Controller struct {
	...
	websitesLister        examplelisters.WebsiteLister
...
func NewController(
	...
	websiteInformer exampleinformers.WebsiteInformer) *Controller {

	// Create event broadcaster
	// Add sample-controller types to the default Kubernetes Scheme so Events can be
	// logged for sample-controller types.
	utilruntime.Must(examplescheme.AddToScheme(scheme.Scheme))
...
func (c *Controller) updateWebsiteStatus(website *examplev1.Website, deployment *appsv1.Deployment) error {
	...
	_, err := c.exampleClientset.SmartxV1().Websites(website.Namespace).Update(websiteCopy)
	return err
}
...
func newDeployment(website *examplev1.Website) *appsv1.Deployment {
	...
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*metav1.NewControllerRef(website, examplev1.SchemeGroupVersion.WithKind("Website")),
			},
		},
